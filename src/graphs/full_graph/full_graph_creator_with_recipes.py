...
collections_recipe = database['recipe']




#Getting the dataset from MongoDB into Pandas for molecules
flavorDB_pandas = pd.DataFrame(list(collections_molecule.find()))
